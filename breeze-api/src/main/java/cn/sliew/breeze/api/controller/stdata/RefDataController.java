package cn.sliew.breeze.api.controller.stdata;
...
public class RefDataController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_DELETE)")
