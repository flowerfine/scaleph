...
import cn.sliew.breeze.api.security.OnlineUserService;
import cn.sliew.breeze.api.security.TokenProvider;
import cn.sliew.breeze.api.security.UserDetailInfo;
...
import cn.sliew.breeze.service.util.RedisUtil;
...
public class UserController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).USER_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).USER_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).USER_DELETE)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).USER_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).ROLE_GRANT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).DEPT_GRANT)")
