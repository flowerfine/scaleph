package cn.sliew.breeze.api.controller.opscenter;
...
public class JobLogController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).OPSCENTER_BATCH_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).OPSCENTER_REALTIME_SELECT)")
