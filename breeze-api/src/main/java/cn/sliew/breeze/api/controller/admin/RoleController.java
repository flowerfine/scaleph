...
import cn.sliew.breeze.common.enums.RoleTypeEnum;
import cn.sliew.breeze.service.admin.DeptRoleService;
import cn.sliew.breeze.service.admin.RoleService;
import cn.sliew.breeze.service.admin.UserRoleService;
...
public class RoleController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).ROLE_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).ROLE_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).ROLE_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.breeze.common.constant.PrivilegeConstants).ROLE_DELETE)")
