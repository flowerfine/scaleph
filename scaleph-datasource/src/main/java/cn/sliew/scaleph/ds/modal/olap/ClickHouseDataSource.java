...
public class ClickHouseDataSource extends AbstractDataSource {
    ...
    @NotBlank
    @ApiModelProperty("clickhouse host")
    private String host;

    @NotBlank
    @ApiModelProperty("clickhouse database")
    private String database;

    @NotBlank
    @ApiModelProperty("clickhouse username")
    private String username;

    @NotBlank
    @ApiModelProperty("clickhouse password")
    ...
    public DsInfoDTO toDsInfo() {
        ...
        Map<String, Object> props = Map.of("host", host, "database", database, "username", username, "password", CodecUtil.encrypt(password));
        dto.setProps(props);
        return dto;
    }
}
