...
@Component({
  selector: 'app-realtime-job',
  templateUrl: './realtime-job.component.html',
  styleUrls: ['./realtime-job.component.scss'],
})
export class RealtimeJobComponent implements OnInit {
  ...
  refreshTable() {
    ...
    this.jobLogService.listRealtimeByPage(param).subscribe((d) => {
