...
@Component({
  selector: 'app-doris-datasource',
  templateUrl: './doris-datasource.component.html',
  styleUrls: ['../datasource.component.scss'],
})
export class DorisDatasourceComponent implements OnInit {
  parent: HTMLElement;
  @Input() data: any;
  ...
  formConfig: { [Key: string]: DValidateRules } = {
    ...
    portRules: {
      validators: [{ required: true }, { maxlength: 32 }],
    },
    databaseNameRules: {
  ...
  submitForm({ valid }) {
    let ds: MetaDataSource = {
      ...
      props: {
        ...
        httpPort: this.formData.httpPort,
