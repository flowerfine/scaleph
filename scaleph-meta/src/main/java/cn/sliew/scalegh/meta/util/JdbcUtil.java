package cn.sliew.scalegh.meta.util;
...
import cn.sliew.scalegh.common.exception.CustomException;
import cn.sliew.scalegh.meta.database.AbstractDatabaseMeta;
import cn.sliew.scalegh.meta.database.MysqlDatabaseMeta;
import cn.sliew.scalegh.meta.database.OracleDatabaseMeta;
...
public class JdbcUtil {
    ...
    public static DataSource getDataSource(AbstractDatabaseMeta meta) {
        if (meta == null) {
            ...
            dataSource.setPoolName(meta.getDataSourceName());
            ...
            if (meta.getPoolProps() != null) {
                Properties poolProps = meta.getPoolProps();
                if (poolProps.containsKey("minIdle")) {
