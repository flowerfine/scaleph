...
public interface MetaDataElementConvert extends BaseConvert<MetaDataElement, MetaDataElementDTO> {
    ...
    @Override
    @Mapping(expression = "java(cn.sliew.scaleph.service.vo.DictVO.toVO(cn.sliew.scaleph.common.constant.DictConstants.YES_NO,entity.getNullable()))", target = "nullable")
    @Mapping(expression = "java(cn.sliew.scaleph.service.vo.DictVO.toVO(cn.sliew.scaleph.common.constant.DictConstants.DATA_TYPE,entity.getDataType()))", target = "dataType")
