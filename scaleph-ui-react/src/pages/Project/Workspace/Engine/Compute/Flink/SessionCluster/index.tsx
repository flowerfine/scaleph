                    ...
                    {access.canAccess(PRIVILEGE_CODE.datadevProjectEdit) && (
                        <Tooltip title={intl.formatMessage({id: 'app.common.operate.edit.label'})}>
                            <Button
                                ...
                                onClick={() => {
                                    history.push("/workspace/engine/compute/flink/session-cluster/steps/update", record)
                                }}
                            />
                        </Tooltip>
                    )}
                    {access.canAccess(PRIVILEGE_CODE.datadevProjectEdit) && (
                        <Tooltip title={intl.formatMessage({id: 'app.common.operate.detail.label'})}>
                            <Button
                                ...
                                type="link"
                                icon={<EyeOutlined/>}
                                onClick={() => history.push("/workspace/engine/compute/flink/session-cluster/detail", record)}
                            />
                        </Tooltip>
                    )}
                ...
                actions: [
                    access.canAccess(PRIVILEGE_CODE.datadevResourceAdd) && (
                        <Button
                            ...
                            type="primary"
                            onClick={() => {
                                history.push("/workspace/engine/compute/flink/session-cluster/steps/new")
                            }}
                        >
