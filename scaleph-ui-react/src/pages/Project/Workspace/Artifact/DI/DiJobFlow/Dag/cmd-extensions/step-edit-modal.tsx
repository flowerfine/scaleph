...
import SinkKafkaStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-kafka-step";
import SourceNeo4jStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-neo4j-step";
import SourceInfluxDBStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-influxdb-step";
import SourceSftpFileStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-sftp-file-step";
import SinkSftpFileStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-sftp-file-step";
import SourceOSSJindoFileStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-ossjindo-file-step";
import SinkOSSJindoFileStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-ossjindo-file-step";
import SourceCassandraStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-cassandra-step";
import SinkCassandraStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-cassandra-step";
import SinkDorisStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-doris-step";
import SinkStarRocksStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-starrocks-step";
import SourceMaxComputeStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-maxcompute-step";
import SinkMaxComputeStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-maxcompute-step";
import SinkInfluxDBStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-influxdb-step";
import SourceAmazonDynamodbStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-dynamodb-step";
import SinkAmazonDynamodbStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-dynamodb-step";
import SinkS3RedshiftStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/sink/sink-s3redshift-file-step";
import SourceOpenMLDBStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-openmldb-step";
import SourceCDCMySQLStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-cdc-mysql-step";
import TransformCopyStepForm from '@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-copy-step';
import TransformFieldMapperStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-field-mapper-step";
import TransformFilterRowKindStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-filter-row-kind-step";
import TransformFilterStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-filter-step";
import TransformReplaceStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-replace-step";
import TransformSplitStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-split-step";
import TransformSqlStepForm from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/transform/transform-sql-step";
import SourceElasticsearchStepForm
  from "@/pages/Project/Workspace/Artifact/DI/DiJobFlow/Dag/steps/source/source-elasticsearch-step";
