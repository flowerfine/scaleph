...
import { bindEmail, getAuthCode, isEmailExists } from "@/services/admin/user.service";
        ...
        <Modal
            ...
            onOk={() => {
                form.validateFields().then((values) => {
                    bindEmail(values.email, values.authCode).then(d => {
                        if (d.success) {
                    ...
                    <Row gutter={[16, 0]}>
                        ...
                        <Col span={8} style={{ textAlign: 'right' }}>
                            <Button
                                ...
                                onClick={() => {
                                    let m = form.getFieldValue('email');
                                    getAuthCode(m).then(d => {
                                        message.info(intl.formatMessage({ id: 'pages.admin.usercenter.security.email.authCode.info' }));
                                    })
                                }}>
