...
const ClickHouseDataSourceForm: React.FC<ModalFormProps<MetaDataSource>> = ({
                                                                           data,
                                                                           visible,
                                                                           onVisibleChange,
                                                                           onCancel,
    ...
    >
      ...
      >
        ...
        <Form.Item
          ...
          tooltip={{
            title: intl.formatMessage({id: 'pages.project.di.dataSource.clickhosue.host.tooltip'}),
...
export default ClickHouseDataSourceForm;
