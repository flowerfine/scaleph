...
import { deleteResourceBatch, deleteResourceRow, listResourceFileByPage } from "@/services/resource/cluster.service";
    ...
    const tableColumns: ProColumns<DiResourceFile>[] = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <>
                    <Space>
                        {access.canAccess(PRIVILEGE_CODE.datadevResourceEdit) && (
                            <Tooltip title={intl.formatMessage({ id: 'app.common.operate.edit.label' })}>
                                <Button
                                    ...
                                    icon={<EditOutlined />}
                                    onClick={() => {
                                        setResourceFormData({ visiable: true, data: record });
                                    }}
                                ></Button>
                            </Tooltip>
                        )}
