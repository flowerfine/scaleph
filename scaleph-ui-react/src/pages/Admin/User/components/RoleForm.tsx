...
import { updateRole, addRole } from "@/services/admin/role.service";
...
const RoleForm: React.FC<ModalFormProps<SecRole>> = ({
    ...
    return (
        <Modal
            ...
            title={
                data.id ?
                    intl.formatMessage({ id: 'app.common.operate.edit.label' }) + intl.formatMessage({ id: 'pages.admin.user.role' }) :
                    intl.formatMessage({ id: 'app.common.operate.new.label' }) + intl.formatMessage({ id: 'pages.admin.user.role' })
            }
            width={580}
            destroyOnClose={true}
            onCancel={onCancel}
