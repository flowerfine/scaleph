...
import { deleteClusterBatch, deleteClusterRow, listClusterByPage } from "@/services/cluster/cluster.service";
...
const Cluster: React.FC = () => {
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        Modal.confirm({
                                            ...
                                            onOk() {
                                                deleteClusterRow(record).then((d) => {
                                                    if (d.success) {
                                                        message.success(
    ...
    useEffect(() => {
        listDictDataByType(DICT_TYPE.clusterType).then((d) => {
    ...
    return (<div>
        <ProTable<DiClusterConfig>
            ...
            request={(params, sorter, filter) => {
                return listClusterByPage(params);
            }}
            toolbar={{
                actions: [
                        ...
                        <Button
                            ...
                            onClick={() => {
                                Modal.confirm({
                                    ...
                                    cancelText: intl.formatMessage({ id: 'app.common.operate.cancel.label' }),
                                    onOk() {
                                        deleteClusterBatch(selectedRows).then((d) => {
                                            if (d.success) {
                                                message.success(
                                                    intl.formatMessage({ id: 'app.common.operate.delete.success' }),
                                                );
