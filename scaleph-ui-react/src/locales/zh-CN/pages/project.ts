export default {
  ...
  'pages.project.di.step.baseFile.customFilename': 'Whether Custom Filename',
  ...
  'pages.project.di.step.baseFile.havePartition': 'Have Partition',
  ...
  'pages.project.di.step.baseFile.compressCodec': 'Compress Codec',
  ...
  'pages.project.di.step.doris.tableIdentifier': 'Table',
  'pages.project.di.step.doris.sinkLabelPrefix': 'Label Prefix',
  'pages.project.di.step.doris.sinkEnable2PC': 'Enable 2PC',
  'pages.project.di.step.doris.sinkEnableDelete': 'Enable Delete',
  'pages.project.di.step.doris.dorisConfig': 'Stream Load Config',
  'pages.project.di.step.doris.dorisConfig.tooltip': 'The way to specify the parameter is to add the prefix sink.properties. to the original stream load parameter',
  'pages.project.di.step.doris.dorisConfig.list': 'Config',
  'pages.project.di.step.doris.dorisConfig.key': 'Config',
  'pages.project.di.step.doris.dorisConfig.key.placeholder': 'format',
  'pages.project.di.step.doris.dorisConfig.value': 'Value',
  ...
  'pages.project.di.step.starrocks.enableUpsertDelete': 'Enable Upsert or Delete',
  'pages.project.di.step.starrocks.saveModeCreateTemplate': 'Table Template',
  'pages.project.di.step.starrocks.starrocksConfig': 'StarRocks Config',
  'pages.project.di.step.starrocks.starrocksConfig.tooltip': 'stream load parameter',
  'pages.project.di.step.starrocks.starrocksConfig.list': 'Config',
  'pages.project.di.step.starrocks.starrocksConfigKey': 'Key',
  'pages.project.di.step.starrocks.starrocksConfigKey.placeholder': 'format',
  'pages.project.di.step.starrocks.starrocksConfigValue': 'Value',
  ...
  'pages.project.di.step.cdc.hostname': 'Host',
  'pages.project.di.step.cdc.port': 'Port',
  'pages.project.di.step.cdc.username': 'Username',
  'pages.project.di.step.cdc.password': 'Password',
  'pages.project.di.step.cdc.database': 'Database',
  'pages.project.di.step.cdc.table': 'Table',
  'pages.project.di.step.cdc.startupMode': 'Startup Mode',
  'pages.project.di.step.cdc.startupTimestamp': 'Startup Timestamp',
  'pages.project.di.step.cdc.startupSpecificOffsetFile': 'Startup Specific Offset File',
  'pages.project.di.step.cdc.startupSpecificOffsetPos': 'Startup Specific Offset Pos',
  'pages.project.di.step.cdc.stopMode': 'Stop Mode',
  'pages.project.di.step.cdc.stopTimestamp': 'Stop Timestamp',
  'pages.project.di.step.cdc.stopSpecificOffsetFile': 'Stop Specific Offset File',
  'pages.project.di.step.cdc.stopSpecificOffsetPos': 'Stop Specific Offset Pos',
  'pages.project.di.step.cdc.incrementalParallelism': 'Incremental Parallelism',
  'pages.project.di.step.cdc.snapshotSplitSize': 'Snapshot Split Size',
  'pages.project.di.step.cdc.snapshotFetchSize': 'Snapshot Fetch Size',
  'pages.project.di.step.cdc.serverId': 'Server Id',
  'pages.project.di.step.cdc.serverTimeZone': 'Server TimeZone',
  'pages.project.di.step.cdc.connectTimeout': 'Connect Timeout',
  'pages.project.di.step.cdc.connectMaxRetries': 'Connect Max Retries',
  'pages.project.di.step.cdc.connectionPoolSize': 'Connection Pool Size',
  ...
  'pages.project.di.step.cdc.debeziums': 'Debezium Properties',
  'pages.project.di.step.cdc.debeziums.tooltip': 'Pass-through Debezium\'s properties to Debezium Embedded Engine which is used to capture data changes from MySQL server',
  'pages.project.di.step.cdc.debeziums.list': 'Property',
  'pages.project.di.step.cdc.debeziums.property': 'Property',
  ...
  'page.project.cluster.config.resourceProvider': '资源类型',
  'page.project.cluster.config.deployMode': '部署模式',
  'page.project.cluster.config.clusterCredential': '集群凭证',
  'page.project.cluster.config.flinkVersion': 'Flink 版本',
  'page.project.cluster.config.flinkRelease': 'Flink Release',
  'page.project.cluster.config.kubernetesStep': 'Kubernetes',
  'page.project.cluster.config.namespace': 'Namespace',
  'page.project.cluster.config.serviceAccount': 'Service Account',
  'page.project.cluster.config.context': 'Kubeconfig Context',
  'page.project.cluster.config.registry': 'Image Registry',
  'page.project.cluster.config.repository': 'Image Repository',
  'page.project.cluster.config.image': 'Image',
  'page.project.cluster.config.imagePullPolicy': 'Image Pull Policy',
  'page.project.cluster.config.jobManagerCPU': 'JobManager Pod CPU',
  'page.project.cluster.config.jobManagerMemory': 'JobManager Pod Memory',
  'page.project.cluster.config.jobManagerReplicas': 'JobManager Pod Replicas',
  'page.project.cluster.config.taskManagerCPU': 'TaskManager Pod CPU',
  'page.project.cluster.config.taskManagerMemory': 'TaskManager Pod Memory',
  'page.project.cluster.config.taskManagerReplicas': 'TaskManager Pod Replicas',
  'page.project.cluster.config.configOptionsStep': 'Advance Options',
  'page.project.cluster.config.configOptions': '自定义配置项',
  'page.project.cluster.config.configOptions.key': 'ConfigOption',
  'page.project.cluster.config.configOptions.value': 'Value',
  'pages.project.cluster.instance.create': '生成集群实例',
  'pages.project.cluster.instance.create.confirm': '确定创建集群实例?',
  'pages.project.cluster.instance': '集群实例',
  'pages.project.cluster.instance.flinkClusterConfigId': '集群配置 ID',
  'pages.project.cluster.instance.name': '实例名称',
  'pages.project.cluster.instance.clusterId': 'Cluster ID',
  ...
  'pages.project.job.detail.metrics': '度量',
  'pages.project.job.detail.logs': '日志',
  'pages.project.job.detail.overview': '概览',
  'pages.project.job.detail.jobHistory': '作业历史',
  'pages.project.job.detail.overview.basic': '作业基础信息',
  'pages.project.job.detail.overview.basic.artifactType': 'Artifact 类型',
  'pages.project.job.detail.overview.basic.jar': 'Jar',
  'pages.project.job.detail.overview.basic.jarPath': 'Jar 路径',
  'pages.project.job.detail.overview.basic.jarVersion': 'Jar 版本',
  'pages.project.job.detail.overview.basic.mainClass': '主类',
  'pages.project.job.detail.overview.basic.flinkVersion': 'Flink 版本',
  'pages.project.job.detail.overview.basic.creator': '创建人',
  'pages.project.job.detail.overview.basic.editor': '修改人',
  'pages.project.job.detail.overview.cluster': '集群信息',
  'pages.project.job.detail.overview.cluster.id': '集群ID',
  'pages.project.job.detail.overview.cluster.name': '集群名称',
  'pages.project.job.detail.overview.cluster.status': '集群状态',
  'pages.project.job.detail.overview.cluster.webui': '集群地址',
  'pages.project.job.detail.config.state': 'State',
  'pages.project.job.detail.config.checkpoint': 'Checkpoints & Savepoints',
  'pages.project.job.detail.config.savepoint': 'Savepoints ',
  'pages.project.job.detail.config.resource': 'Resource Configuration',
  'pages.project.job.detail.config.fault': 'Fault Tolerance',
