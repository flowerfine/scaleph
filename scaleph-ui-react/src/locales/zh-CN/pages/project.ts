export default {
  ...
  'pages.project.di.step.cdcmysql.table': 'Table',
  'pages.project.di.step.cdcmysql.startupMode': 'Startup Mode',
  'pages.project.di.step.cdcmysql.startupTimestamp': 'Startup Timestamp',
  'pages.project.di.step.cdcmysql.startupSpecificOffsetFile': 'Startup Specific Offset File',
  'pages.project.di.step.cdcmysql.startupSpecificOffsetPos': 'Startup Specific Offset Pos',
  'pages.project.di.step.cdcmysql.stopMode': 'Stop Mode',
  'pages.project.di.step.cdcmysql.stopTimestamp': 'Stop Timestamp',
  'pages.project.di.step.cdcmysql.stopSpecificOffsetFile': 'Stop Specific Offset File',
  'pages.project.di.step.cdcmysql.stopSpecificOffsetPos': 'Stop Specific Offset Pos',
  'pages.project.di.step.cdcmysql.incrementalParallelism': 'Incremental Parallelism',
  'pages.project.di.step.cdcmysql.snapshotSplitSize': 'Snapshot Split Size',
  'pages.project.di.step.cdcmysql.snapshotFetchSize': 'Snapshot Fetch Size',
  'pages.project.di.step.cdcmysql.serverId': 'Server Id',
  'pages.project.di.step.cdcmysql.serverTimeZone': 'Server TimeZone',
  'pages.project.di.step.cdcmysql.connectTimeout': 'Connect Timeout',
  'pages.project.di.step.cdcmysql.connectMaxRetries': 'Connect Max Retries',
  'pages.project.di.step.cdcmysql.connectionPoolSize': 'Connection Pool Size',
  'pages.project.di.step.cdcmysql.chunkKeyEvenDistributionFactorUpperBound': 'Chunk Key Even Distribution Factor Upper Bound',
  'pages.project.di.step.cdcmysql.chunkKeyEvenDistributionFactorLowerBound': 'Chunk Key Even Distribution Factor Lower Bound',
  'pages.project.di.step.cdcmysql.debeziums': 'Debezium Properties',
  'pages.project.di.step.cdcmysql.debeziums.tooltip': 'Pass-through Debezium\'s properties to Debezium Embedded Engine which is used to capture data changes from MySQL server',
  'pages.project.di.step.cdcmysql.debeziums.list': 'Property',
  'pages.project.di.step.cdcmysql.debeziums.property': 'Property',
