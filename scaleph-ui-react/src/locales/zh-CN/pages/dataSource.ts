export default {
  'pages.dataSource': '数据源',
  'pages.dataSource.remark': '备注',
  'pages.dataSource.createTime': '创建时间',
  ...
  'pages.dataSource.step.type': '数据源',
  'pages.dataSource.step.props': '属性',
  'pages.dataSource.step.props.type': '数据源',
  'pages.dataSource.step.props.version': '数据源版本',
  'pages.dataSource.step.props.name': '数据源名称',

  'pages.dataSource.step.props.jdbc.driverClassName': 'Driver Class',
  'pages.dataSource.step.props.jdbc.url': 'URL',
  'pages.dataSource.step.props.jdbc.user': '用户名',
  'pages.dataSource.step.props.jdbc.password': '密码',
