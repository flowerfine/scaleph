...
public interface DataserviceResultMapConvert extends BaseConvert<DataserviceResultMap, DataserviceResultMapDTO> {
    DataserviceResultMapConvert INSTANCE = Mappers.getMapper(DataserviceResultMapConvert.class);
