...
public class CheckpointEnvConverter implements EnvConverter {
    ...
    public static final PropertyDescriptor<Integer> CHECKPOINT_INTERVAL =
    ...
    public static final PropertyDescriptor<String> CHECKPOINT_MODE =
        new PropertyDescriptor.Builder<>()
    ...
    public static final PropertyDescriptor<String> CHECKPOINT_DATA_URI =
        new PropertyDescriptor.Builder<>()
    ...
    public static final PropertyDescriptor<Integer> CHECKPOINT_TIMEOUT =
        new PropertyDescriptor.Builder<>()
    ...
    public static final PropertyDescriptor<Integer> MAX_CONCURRENT_CHECKPOINTS =
        new PropertyDescriptor.Builder<>()
    ...
    public static final PropertyDescriptor<String> CHECKPOINT_CLEANUP_MODE =
        new PropertyDescriptor.Builder<>()
            .name("execution.checkpoint.cleanup-mode")
            .description(
                "The mode defines how an externalized checkpoint should be cleaned up on job cancellation")
            .parser(Parsers.STRING_PARSER)
            .addValidator(Validators.NON_BLANK_VALIDATOR)
            .validateAndBuild();

    public static final PropertyDescriptor<Integer> MIN_PAUSE_BETWEEN_CHECKPOINTS =
        new PropertyDescriptor.Builder<>()
    ...
    public static final PropertyDescriptor<Integer> FAIL_ON_CHECKPOINTING_ERRORS =
        new PropertyDescriptor.Builder<>()
