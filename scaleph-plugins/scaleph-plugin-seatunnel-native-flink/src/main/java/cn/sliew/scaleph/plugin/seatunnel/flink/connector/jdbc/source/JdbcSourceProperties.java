...
public enum JdbcSourceProperties {
    ...
    public static final PropertyDescriptor<Integer> FETCH_SIZE =
    ...
    public static final PropertyDescriptor<String> PARTITION_COLUMN =
        new PropertyDescriptor.Builder<String>()
    ...
    public static final PropertyDescriptor<Long> PARTITION_UPPER_BOUND =
        new PropertyDescriptor.Builder<String>()
    ...
    public static final PropertyDescriptor<Long> PARTITION_LOWER_BOUND =
        new PropertyDescriptor.Builder<String>()
