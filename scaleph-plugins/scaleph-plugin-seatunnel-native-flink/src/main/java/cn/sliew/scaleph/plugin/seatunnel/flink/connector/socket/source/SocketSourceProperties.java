...
public enum SocketSourceProperties {
    ...
    public static final PropertyDescriptor<Integer> PORT = new PropertyDescriptor.Builder<String>()
            .name("port")
