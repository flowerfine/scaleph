...
public class RoutePlugin extends FlinkCDCPipilineConnectorPlugin {
    ...
    public RoutePlugin() {
        ...
        props.add(RouteProperties.SOURCE_TABLE);
        props.add(RouteProperties.SINK_TABLE);
    ...
    protected FlinkCDCPluginMapping getPluginMapping() {
        return FlinkCDCPluginMapping.ROUTE_ROUTE;
    }
}
