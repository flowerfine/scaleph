...
package cn.sliew.scaleph.plugin.seatunnel.flink.connectors.dynamodb.sink;
...
public class DynamoDBSinkPlugin extends SeaTunnelConnectorPlugin {
    ...
    public DynamoDBSinkPlugin() {
        this.pluginInfo = new PluginInfo(getIdentity(),
                "Write data to Amazon DynamoDB",
                DynamoDBSinkPlugin.class.getName());
    ...
    protected SeaTunnelPluginMapping getPluginMapping() {
        return SeaTunnelPluginMapping.SINK_AMAZON_DYNAMODB;
    }
}
