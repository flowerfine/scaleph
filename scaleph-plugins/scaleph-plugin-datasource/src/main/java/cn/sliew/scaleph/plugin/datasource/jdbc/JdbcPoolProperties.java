...
public enum JdbcPoolProperties {
    ...
    public static final PropertyDescriptor<String> DRIVER_CLASS_NAME =
        new PropertyDescriptor.Builder()
            .name("driverClassName")
            .description(
                "fully-qualified class name of the JDBC driver. Example: com.mysql.cj.jdbc.Driver")
            .parser(Parsers.STRING_PARSER)
            .addValidator(Validators.NON_BLANK_VALIDATOR)
            .properties(Property.Required)
            .validateAndBuild();
    ...
    public static final PropertyDescriptor<Integer> MAXIMUM_POOL_SIZE =
        new PropertyDescriptor.Builder()
    ...
    public static final PropertyDescriptor<String> VALIDATION_QUERY =
        new PropertyDescriptor.Builder()
