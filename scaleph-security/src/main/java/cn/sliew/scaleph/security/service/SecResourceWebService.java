...
public interface SecResourceWebService {
    ...
    Page<SecResourceWebDTO> listByPage(SecPrivilegeListParam param);

    List<SecResourceWebDTO> listAll(String resourceType);

    List<SecResourceWebDTO> listByPid(Long pid, String privilegeName);

    int insert(SecPrivilegeAddParam param);

    int update(SecPrivilegeUpdateParam param);
