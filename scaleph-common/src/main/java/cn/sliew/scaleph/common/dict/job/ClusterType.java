...
public enum ClusterType implements DictInstance {
    ...
    @JsonCreator
    public static ClusterType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, ClusterType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(ClusterType.class, value));
    }
