...
public enum FlinkStateBackend implements DictInstance {
    ...
    @JsonCreator
    public static FlinkStateBackend of(@JsonProperty("vlaue") String value) {
        return Enums.toEnum(value, FlinkStateBackend.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkStateBackend.class, value));
    }
    ...
    FlinkStateBackend(String value, String label) {
        this.value = value;
        this.label = label;
    }
