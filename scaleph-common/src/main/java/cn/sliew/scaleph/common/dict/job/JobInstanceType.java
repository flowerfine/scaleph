...
public enum JobInstanceType implements DictInstance {
    ...
    @JsonCreator
    public static JobInstanceType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, JobInstanceType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(JobInstanceType.class, value));
    }
    ...
    JobInstanceType(String value, String label) {
        this.value = value;
        this.label = label;
    }
    ...
    public DictDefinition getDefinition() {
        return DictType.JOB_INSTANCE_TYPE;
    }
