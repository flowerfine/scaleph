...
public enum FlinkClusterStatus implements DictInstance {
    ...
    @JsonCreator
    public static FlinkClusterStatus of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkClusterStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkClusterStatus.class, value));
    }
