...
public enum FlinkHighAvailability implements DictInstance {
    ...
    @JsonCreator
    public static FlinkHighAvailability of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkHighAvailability.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkHighAvailability.class, value));
    }
    ...
    FlinkHighAvailability(String value, String label) {
        this.value = value;
        this.label = label;
    }
