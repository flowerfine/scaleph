...
public enum FlinkSemantic implements DictInstance {
    ...
    @JsonCreator
    public static FlinkSemantic of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkSemantic.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkSemantic.class, value));
    }
    ...
    FlinkSemantic(String value, String label) {
        this.value = value;
        this.label = label;
    }
