...
public enum SeaTunnelEngineType implements DictInstance {
    ...
    @JsonCreator
    public static SeaTunnelEngineType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, SeaTunnelEngineType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(SeaTunnelEngineType.class, value));
    }
