...
public enum FlinkResourceProvider implements DictInstance {
    ...
    @JsonCreator
    public static FlinkResourceProvider of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkResourceProvider.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkResourceProvider.class, value));
    }
    ...
    FlinkResourceProvider(String value, String label) {
        this.value = value;
        this.label = label;
    }
