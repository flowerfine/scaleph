...
public enum TaskResult implements DictInstance {
    ...
    @JsonCreator
    public static TaskResult of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, TaskResult.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(TaskResult.class, value));
    }
    ...
    TaskResult(String value, String label) {
        this.value = value;
        this.label = label;
    }
