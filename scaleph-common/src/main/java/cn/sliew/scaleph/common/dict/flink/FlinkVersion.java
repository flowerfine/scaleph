...
public enum FlinkVersion implements DictInstance {
    ...
    @JsonCreator
    public static FlinkVersion of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkVersion.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkVersion.class, value));
    }
