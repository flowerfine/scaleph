...
public enum IdCardType implements DictInstance {
    ...
    @JsonCreator
    public static IdCardType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, IdCardType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(IdCardType.class, value));
    }
    ...
    IdCardType(String value, String label) {
        this.value = value;
        this.label = label;
    }
