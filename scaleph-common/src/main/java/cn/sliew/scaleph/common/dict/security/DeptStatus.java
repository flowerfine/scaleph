...
public enum DeptStatus implements DictInstance {
    ...
    @JsonCreator
    public static DeptStatus of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, DeptStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(DeptStatus.class, value));
    }
    ...
    DeptStatus(String value, String label) {
        this.value = value;
        this.label = label;
    }
