...
public enum JobStatus implements DictInstance {
    ...
    @JsonCreator
    public static JobStatus of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, JobStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(JobStatus.class, value));
    }
