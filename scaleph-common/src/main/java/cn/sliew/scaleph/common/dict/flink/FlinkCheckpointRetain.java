...
public enum FlinkCheckpointRetain implements DictInstance {
    ...
    @JsonCreator
    public static FlinkCheckpointRetain of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkCheckpointRetain.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkCheckpointRetain.class, value));
    }
    ...
    FlinkCheckpointRetain(String value, String label) {
        this.value = value;
        this.label = label;
    }
