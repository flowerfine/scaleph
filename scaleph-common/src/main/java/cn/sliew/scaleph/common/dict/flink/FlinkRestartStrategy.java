...
public enum FlinkRestartStrategy implements DictInstance {
    ...
    @JsonCreator
    public static FlinkRestartStrategy of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkRestartStrategy.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkRestartStrategy.class, value));
    }
    ...
    FlinkRestartStrategy(String value, String label) {
        this.value = value;
        this.label = label;
    }
