...
public enum Gender implements DictInstance {
    ...
    @JsonCreator
    public static Gender of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, Gender.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(Gender.class, value));
    }
