...
public enum FlinkJobStatus implements DictInstance {
    ...
    ;
    @JsonCreator
    public static FlinkJobStatus of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkJobStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkJobStatus.class, value));
    }
