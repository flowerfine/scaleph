...
public enum PageCode {
    ...
    public static final String RESOURCE_JAR = "rej";
    public static final String RESOURCE_FLINK_RELEASE = "rfr";
    ...
    public static final String ADMIN_DICT_DATA = "ada";
    public static final String ADMIN_SETTING = "ads";
}
