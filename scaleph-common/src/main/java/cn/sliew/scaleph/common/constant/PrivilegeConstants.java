...
public interface PrivilegeConstants {
    ...
    String DATADEV_DATASOURCE_SHOW =
    ...
    String OPSCENTER_REALTIME_SHOW =
    ...
    String STDATA_REF_DATA_MAP_SHOW =
    ...
    String STDATA_DATA_ELEMENT_SHOW =
    ...
    String DATADEV_DATASOURCE_SELECT =
    ...
    String DATADEV_DATASOURCE_DELETE =
    ...
    String DATADEV_DATASOURCE_EDIT =
    ...
    String DATADEV_DATASOURCE_SECURITY =
    ...
    String DATADEV_RESOURCE_SELECT =
    ...
    String DATADEV_RESOURCE_DELETE =
    ...
    String DATADEV_RESOURCE_DOWNLOAD =
    ...
    String OPSCENTER_REALTIME_SELECT =
    ...
    String STDATA_REF_DATA_TYPE_SELECT =
    ...
    String STDATA_REF_DATA_TYPE_ADD =
    ...
    String STDATA_REF_DATA_TYPE_DELETE =
    ...
    String STDATA_REF_DATA_TYPE_EDIT =
    ...
    String STDATA_REF_DATA_MAP_SELECT =
    ...
    String STDATA_REF_DATA_MAP_ADD =
    ...
    String STDATA_REF_DATA_MAP_DELETE =
    ...
    String STDATA_REF_DATA_MAP_EDIT =
    ...
    String STDATA_DATA_ELEMENT_SELECT =
    ...
    String STDATA_DATA_ELEMENT_ADD =
    ...
    String STDATA_DATA_ELEMENT_DELETE =
    ...
    String STDATA_DATA_ELEMENT_EDIT =
