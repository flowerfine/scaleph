...
public enum DataSourceType implements DictInstance {
    ...
    @JsonCreator
    public static DataSourceType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, DataSourceType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(DataSourceType.class, value));
    }
