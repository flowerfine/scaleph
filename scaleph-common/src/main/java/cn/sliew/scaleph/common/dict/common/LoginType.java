...
public enum LoginType implements DictInstance {
    ...
    @JsonCreator
    public static LoginType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, LoginType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(LoginType.class, value));
    }
    ...
    LoginType(String value, String label) {
        this.value = value;
        this.label = label;
    }
