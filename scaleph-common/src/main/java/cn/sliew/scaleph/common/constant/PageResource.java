...
public enum PageResource {
    ...
    public static Route DATA_SOURCE = new Route(400000, "数据源", PageCode.DATA_SOURCE, "/dataSource", MenuResource.DATA_SOURCE);
    ...
    public static Route ADMIN_PRIVILEGE = new Route(600001, "权限管理", PageCode.ADMIN_PRIVILEGE, "/admin/privilege", MenuResource.ADMIN);
    public static Route ADMIN_WORKFLOW_QUARTZ = new Route(600002, "系统任务", PageCode.ADMIN_WORKFLOW_QUARTZ, "/admin/workflow/quartz", MenuResource.ADMIN);
    public static Route ADMIN_DICT = new Route(600003, "数据字典", PageCode.ADMIN_DICT, "/admin/dict", MenuResource.ADMIN);
    public static Route ADMIN_SETTING = new Route(600004, "系统设置", PageCode.ADMIN_SETTING, "/admin/setting", MenuResource.ADMIN);
