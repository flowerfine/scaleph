...
public enum FlinkDeploymentMode implements DictInstance {
    ...
    @JsonCreator
    public static FlinkDeploymentMode of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, FlinkDeploymentMode.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkDeploymentMode.class, value));
    }
