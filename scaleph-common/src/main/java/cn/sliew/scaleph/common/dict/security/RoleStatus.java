...
public enum RoleStatus implements DictInstance {
    ...
    @JsonCreator
    public static RoleStatus of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, RoleStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RoleStatus.class, value));
    }
    ...
    RoleStatus(String value, String label) {
        this.value = value;
        this.label = label;
    }
