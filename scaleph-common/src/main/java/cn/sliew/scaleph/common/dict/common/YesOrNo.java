...
public enum YesOrNo implements DictInstance {
    ...
    @JsonCreator
    public static YesOrNo of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, YesOrNo.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(YesOrNo.class, value));
    }
