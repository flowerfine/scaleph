...
public enum JobAttrType implements DictInstance {
    ...
    @JsonCreator
    public static JobAttrType of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, JobAttrType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(JobAttrType.class, value));
    }
