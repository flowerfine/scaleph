...
public enum SeaTunnelPluginMapping {
    ...
    SINK_PULSAR(SEATUNNEL, SINK, PULSAR, "connector-pulsar", BETA, BATCH, STREAM, EXACTLY_ONCE, COLUMN_PROJECTION, PARALLELISM),
    ...
    SOURCE_ORACLE_CDC(SEATUNNEL, SOURCE, ORACLE_CDC, "connector-cdc-oracle", UNKNOWN),
    ...
    SOURCE_DORIS(SEATUNNEL, SOURCE, DORIS, "connector-doris", BETA, EXACTLY_ONCE, CDC),
