...
public enum SeaTunnelPluginMapping {
    ...
    SOURCE_OSS_JINDO_FILE(SEATUNNEL, SOURCE, OSS_JINDO_FILE, "connector-file-oss-jindo", UNKNOWN, BATCH, EXACTLY_ONCE, SCHEMA_PROJECTION, PARALLELISM),
    ...
    SOURCE_PULSAR(SEATUNNEL, SOURCE, PULSAR, "connector-pulsar", GA, BATCH, STREAM, EXACTLY_ONCE, SCHEMA_PROJECTION, PARALLELISM),
    ...
    SOURCE_ELASTICSEARCH(SEATUNNEL, SOURCE, ELASTICSEARCH, "connector-elasticsearch", GA, CDC),
    SINK_ELASTICSEARCH(SEATUNNEL, SINK, ELASTICSEARCH, "connector-elasticsearch", GA, CDC),
    SOURCE_MONGODB(SEATUNNEL, SOURCE, MONGODB, "connector-mongodb", BETA, BATCH, SCHEMA_PROJECTION),
    ...
    SOURCE_CASSANDRA(SEATUNNEL, SOURCE, CASSANDRA, "connector-cassandra", GA, BATCH, SCHEMA_PROJECTION),
    SINK_CASSANDRA(SEATUNNEL, SINK, CASSANDRA, "connector-cassandra", GA),
    ...
    SOURCE_STARROCKS(SEATUNNEL, SOURCE, STARROCKS, "connector-starrocks", ALPHA),
