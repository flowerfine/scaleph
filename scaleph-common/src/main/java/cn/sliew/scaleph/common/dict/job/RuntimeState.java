...
public enum RuntimeState implements DictInstance {
    ...
    @JsonCreator
    public static RuntimeState of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, RuntimeState.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RuntimeState.class, value));
    }
    ...
    RuntimeState(String value, String label) {
        this.value = value;
        this.label = label;
    }
