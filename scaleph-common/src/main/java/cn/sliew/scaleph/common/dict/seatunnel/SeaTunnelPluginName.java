...
public enum SeaTunnelPluginName implements DictInstance {
    ...
    @JsonCreator
    public static SeaTunnelPluginName of(@JsonProperty("value") String value) {
        return Enums.toEnum(value, SeaTunnelPluginName.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(SeaTunnelPluginName.class, value));
    }
