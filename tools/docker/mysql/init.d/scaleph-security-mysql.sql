...
INSERT INTO `sec_resource_web`(`id`, `type`, `pid`, `name`, `menu_name`, `path`, `redirect`, `layout`, `icon`, `component`, `remark`, `creator`, `editor`) VALUES (70, '2', 37, 'Flink CDC', 'flink-cdc', '/workspace/data-integration/flink-cdc', NULL, 1, 'SunOutlined', './Project/Workspace/DataIntegration/FlinkCDC', NULL, 'sys', 'sys');
