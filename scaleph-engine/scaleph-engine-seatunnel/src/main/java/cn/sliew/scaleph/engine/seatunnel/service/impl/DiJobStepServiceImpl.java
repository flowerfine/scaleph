...
import cn.sliew.scaleph.engine.seatunnel.service.DiJobStepService;
import cn.sliew.scaleph.engine.seatunnel.service.convert.DiJobStepConvert;
...
public class DiJobStepServiceImpl implements DiJobStepService {
    ...
    public int update(DiJobStepDTO diJobStepDTO) {
        WsDiJobStep step = DiJobStepConvert.INSTANCE.toDo(diJobStepDTO);
    ...
    public int upsert(DiJobStepDTO diJobStep) {
        ...
        WsDiJobStep jobStep = DiJobStepConvert.INSTANCE.toDo(diJobStep);
        if (step == null) {
