...
package cn.sliew.scaleph.workspace.flink.client.v1.model.job;

public enum JobStatus {

    INITIALIZING(JobStatus.TerminalState.NON_TERMINAL),
    ...
    public boolean isGloballyTerminalState() {
        return this.terminalState == JobStatus.TerminalState.GLOBALLY;
    }

    public boolean isTerminalState() {
        return this.terminalState != JobStatus.TerminalState.NON_TERMINAL;
    }

    private enum TerminalState {
        NON_TERMINAL, LOCALLY, GLOBALLY;
    }
}