...
public class FlinkTemplateDefaults extends CustomResource<FlinkTemplateSpec, FlinkDeploymentStatus> implements Resource {

    @Override
    public String getKind() {
        return Constant.FLINK_TEMPLATE_DEFAULTS;
    }
