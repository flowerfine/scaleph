...
package cn.sliew.scaleph.workspace.flink.kubernetes.factory;
...
public enum FlinkDefaultTemplateFactory {
    ...
    private static FlinkTemplate createFlinkTemplateDefaults() {
        ...
        spec.setFlinkVersion(EnumUtils.getEnum(cn.sliew.scaleph.workspace.flink.kubernetes.operator.spec.FlinkVersion.class, flinkVersionMapping.getMajorVersion().getValue()));
