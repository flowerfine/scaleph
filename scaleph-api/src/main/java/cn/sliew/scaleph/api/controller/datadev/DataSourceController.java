...
public class DataSourceController {
    ...
    public ResponseEntity<ResponseVO> showPassword(@PathVariable(value = "id") Long id)
            throws Exception {
        //todo check password param name and get decoded value
//        MetaDatasourceDTO metaDatasourceDTO = this.metaDatasourceService.selectOne(id);
//        if (metaDatasourceDTO == null || StringUtils.isEmpty(metaDatasourceDTO.getPassword())) {
//            return new ResponseEntity<>(ResponseVO.sucess(""), HttpStatus.OK);
//        } else {
//            String passwd = Base64.decodeStr(metaDatasourceDTO.getPassword());
