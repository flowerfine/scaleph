...
public class DataElementController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_DATA_ELEMENT_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_DATA_ELEMENT_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_DATA_ELEMENT_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_DATA_ELEMENT_DELETE)")
