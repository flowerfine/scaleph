...
import cn.sliew.scalegh.common.enums.ClusterTypeEnum;
import cn.sliew.scalegh.common.enums.ErrorShowTypeEnum;
import cn.sliew.scalegh.common.enums.ResourceProvider;
...
public class ClusterController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_CLUSTER_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_CLUSTER_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_CLUSTER_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_CLUSTER_DELETE)")
