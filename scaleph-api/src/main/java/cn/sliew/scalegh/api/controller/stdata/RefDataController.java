package cn.sliew.scalegh.api.controller.stdata;
...
import cn.sliew.scalegh.service.meta.MetaDataMapService;
import cn.sliew.scalegh.service.meta.MetaDataSetService;
import cn.sliew.scalegh.service.meta.MetaDataSetTypeService;
import cn.sliew.scalegh.service.param.meta.MetaDataMapParam;
import cn.sliew.scalegh.service.param.meta.MetaDataSetParam;
import cn.sliew.scalegh.service.param.meta.MetaDataSetTypeParam;
...
public class RefDataController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_DELETE)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_TYPE_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_TYPE_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_TYPE_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_TYPE_DELETE)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_REF_DATA_MAP_DELETE)")
