...
import cn.sliew.scalegh.service.di.DiJobService;
import cn.sliew.scalegh.service.di.DiProjectService;
import cn.sliew.scalegh.service.dto.di.DiProjectDTO;
import cn.sliew.scalegh.service.param.di.DiProjectParam;
...
public class ProjectController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_PROJECT_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_PROJECT_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_PROJECT_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).DATADEV_PROJECT_DELETE)")
