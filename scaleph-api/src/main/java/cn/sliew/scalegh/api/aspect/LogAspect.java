package cn.sliew.scalegh.api.aspect;
...
import cn.sliew.scalegh.common.enums.LoginTypeEnum;
...
public class LogAspect {
     ...
     * 配置拦截Logging注解所有方法
     */
    @Pointcut("@annotation(cn.sliew.scalegh.api.annotation.Logging)")
     ...
     * 登录切面
     */
    @Pointcut("execution(* cn.sliew.scalegh.api.controller.admin.UserController.login(..))")
     ...
     * 登出切面
     */
    @Pointcut("execution(* cn.sliew.scalegh.api.controller.admin.UserController.logout(..))")
