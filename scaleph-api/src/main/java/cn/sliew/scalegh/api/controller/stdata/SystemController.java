...
import cn.sliew.scalegh.service.param.meta.MetaSystemParam;
...
public class SystemController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_SYSTEM_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_SYSTEM_ADD)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_SYSTEM_EDIT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).STDATA_SYSTEM_DELETE)")
