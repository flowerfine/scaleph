...
public class MasterDataSourceConfig {
    ...
    static final String MASTER_ENTITY_PACKAGE = "cn.sliew.scalegh.dao.entity.master";
    static final String MASTER_MAPPER_PACKAGE = "cn.sliew.scalegh.dao.mapper.master";
    static final String MASTER_MAPPER_XML_PATH = "classpath*:cn.sliew.scalegh.dao.mapper/master/**/*.xml";
