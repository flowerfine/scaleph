package cn.sliew.scalegh.api.controller.opscenter;
...
public class JobLogController {
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).OPSCENTER_BATCH_SELECT)")
    ...
    @PreAuthorize("@svs.validate(T(cn.sliew.scalegh.common.constant.PrivilegeConstants).OPSCENTER_REALTIME_SELECT)")
