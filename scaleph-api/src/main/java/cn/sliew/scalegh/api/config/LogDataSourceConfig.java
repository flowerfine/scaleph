...
public class LogDataSourceConfig {
    ...
    static final String LOG_ENTITY_PACKAGE = "cn.sliew.scalegh.dao.entity.log";
    static final String LOG_MAPPER_PACKAGE = "cn.sliew.scalegh.dao.mapper.log";
    static final String LOG_MAPPER_XML_PATH = "classpath*:cn.sliew.scalegh.dao.mapper/log/**/*.xml";
