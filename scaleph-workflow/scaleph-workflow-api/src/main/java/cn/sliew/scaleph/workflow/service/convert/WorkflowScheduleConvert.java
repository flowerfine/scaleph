...
public interface WorkflowScheduleConvert extends BaseConvert<WorkflowSchedule, WorkflowScheduleDTO> {
    WorkflowScheduleConvert INSTANCE = Mappers.getMapper(WorkflowScheduleConvert.class);
