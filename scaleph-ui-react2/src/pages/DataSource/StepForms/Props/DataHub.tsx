  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="endpoint"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.datahub.endpoint'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accessId"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.datahub.accessId'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accessKey"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.datahub.accessKey'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
