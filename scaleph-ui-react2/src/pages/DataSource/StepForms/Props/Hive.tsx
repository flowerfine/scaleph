  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="metastoreUri"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.hive.metastoreUri'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.hive.metastoreUri.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
