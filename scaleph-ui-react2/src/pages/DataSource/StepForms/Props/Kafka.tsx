    ...
    <div>
      <ProCard
        ...
        <ProFormText
          ...
          label={intl.formatMessage({id: 'pages.dataSource.step.props.kafka.bootstrapServers'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.kafka.bootstrapServers.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
