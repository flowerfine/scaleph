  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="nodeUrls"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.starrocks.nodeUrls'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.starrocks.nodeUrls.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
