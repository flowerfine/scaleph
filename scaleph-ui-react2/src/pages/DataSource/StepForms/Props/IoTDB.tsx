  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="nodeUrls"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.iotdb.nodeUrls'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.iotdb.nodeUrls.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="username"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.iotdb.username'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="password"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.iotdb.password'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
