  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name={"uri"}
          label={intl.formatMessage({id: 'pages.dataSource.step.props.mongodb.uri'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.mongodb.uri.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
