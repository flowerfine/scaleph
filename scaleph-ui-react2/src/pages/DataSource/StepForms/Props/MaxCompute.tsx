  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="endpoint"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.maxcompute.endpoint'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accessId"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.maxcompute.accessId'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accesskey"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.maxcompute.accesskey'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
