  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="uri"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.neo4j.uri'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        ...
        <ProFormText
          name="username"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.neo4j.username'})}
          colProps={{span: 21, offset: 1}}
        />
        <ProFormText
          name="password"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.neo4j.password'})}
          colProps={{span: 21, offset: 1}}
        />
        <ProFormText
          name="bearerToken"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.neo4j.bearerToken'})}
          colProps={{span: 21, offset: 1}}
        />
        <ProFormText
          name="kerberosTicket"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.neo4j.kerberosTicket'})}
          colProps={{span: 21, offset: 1}}
        />
      </ProCard>
    </div>
