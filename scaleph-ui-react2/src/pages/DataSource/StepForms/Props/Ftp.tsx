  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="host"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.ftp.host'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        ...
        <ProFormDigit
          name="port"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.ftp.port'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
          initialValue={21}
          fieldProps={{
        ...
        <ProFormText
          name="username"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.ftp.username'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="password"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.ftp.password'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
