  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="masters"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.kudu.masters'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.kudu.masters.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
