  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="nodeUrls"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.doris.nodeUrls'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.doris.nodeUrls.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        ...
        <ProFormText
          name="username"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.doris.username'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="password"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.doris.password'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
