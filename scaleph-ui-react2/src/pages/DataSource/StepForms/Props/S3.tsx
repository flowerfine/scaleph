  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name="bucket"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.s3.bucket'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accessKey"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.s3.accessKey'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="accessSecret"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.s3.accessSecret'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
      </ProCard>
