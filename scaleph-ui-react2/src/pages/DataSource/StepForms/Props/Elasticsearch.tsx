...
const ElasticsearchForm: React.FC = () => {
  const intl = useIntl();
  ...
  return (
    <div>
      <ProCard
        ...
        <ProFormText
          name={"hosts"}
          label={intl.formatMessage({id: 'pages.dataSource.step.props.elasticsearch.hosts'})}
          placeholder={intl.formatMessage({id: 'pages.dataSource.step.props.elasticsearch.hosts.placeholder'})}
          colProps={{span: 21, offset: 1}}
          rules={[{required: true}]}
        />
        <ProFormText
          name="username"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.elasticsearch.username'})}
          colProps={{span: 21, offset: 1}}
        />
        <ProFormText
          name="password"
          label={intl.formatMessage({id: 'pages.dataSource.step.props.elasticsearch.password'})}
          colProps={{span: 21, offset: 1}}
        />
      </ProCard>
    </div>
