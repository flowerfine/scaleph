...
public enum FlinkCheckpointRetain implements DictInstance {
    ...
    @JsonCreator
    public static FlinkCheckpointRetain of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, FlinkCheckpointRetain.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(FlinkCheckpointRetain.class, code));
    }
