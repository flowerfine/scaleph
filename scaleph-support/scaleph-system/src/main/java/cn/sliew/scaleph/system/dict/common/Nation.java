...
public enum Nation implements DictInstance {
    ...
    @JsonCreator
    public static Nation of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, Nation.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(Nation.class, code));
    }
