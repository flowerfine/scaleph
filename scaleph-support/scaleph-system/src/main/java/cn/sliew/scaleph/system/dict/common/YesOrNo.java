...
public enum YesOrNo implements DictInstance {
    ...
    @JsonCreator
    public static YesOrNo of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, YesOrNo.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(YesOrNo.class, code));
    }
