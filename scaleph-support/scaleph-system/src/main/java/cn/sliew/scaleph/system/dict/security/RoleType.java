...
public enum RoleType implements DictInstance {
    ...
    @JsonCreator
    public static RoleType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, RoleType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RoleType.class, code));
    }
