...
public enum RuntimeState implements DictInstance {
    ...
    @JsonCreator
    public static RuntimeState of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, RuntimeState.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RuntimeState.class, code));
    }
