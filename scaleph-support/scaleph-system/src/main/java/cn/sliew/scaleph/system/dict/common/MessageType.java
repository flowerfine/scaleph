...
public enum MessageType implements DictInstance {
    ...
    @JsonCreator
    public static MessageType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, MessageType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(MessageType.class, code));
    }
