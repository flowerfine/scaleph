...
public enum LoginType implements DictInstance {
    ...
    @JsonCreator
    public static LoginType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, LoginType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(LoginType.class, code));
    }
