...
public enum ResourceType implements DictInstance {
    ...
    @JsonCreator
    public static ResourceType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, ResourceType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(ResourceType.class, code));
    }
