...
public enum ClusterType implements DictInstance {
    ...
    @JsonCreator
    public static ClusterType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, ClusterType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(ClusterType.class, code));
    }
