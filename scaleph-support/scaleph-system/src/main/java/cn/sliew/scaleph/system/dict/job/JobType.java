...
public enum JobType implements DictInstance {
    ...
    @JsonCreator
    public static JobType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, JobType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(JobType.class, code));
    }
