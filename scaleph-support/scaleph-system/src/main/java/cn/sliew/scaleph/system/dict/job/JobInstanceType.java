...
public enum JobInstanceType implements DictInstance {
    ...
    @JsonCreator
    public static JobInstanceType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, JobInstanceType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(JobInstanceType.class, code));
    }
    ...
    JobInstanceType(String code, String value) {
        this.code = code;
        this.value = value;
    }
