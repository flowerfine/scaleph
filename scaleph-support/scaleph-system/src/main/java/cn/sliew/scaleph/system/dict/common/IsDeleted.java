...
public enum IsDeleted implements DictInstance {
    ...
    @JsonCreator
    public static IsDeleted of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, IsDeleted.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(IsDeleted.class, code));
    }
