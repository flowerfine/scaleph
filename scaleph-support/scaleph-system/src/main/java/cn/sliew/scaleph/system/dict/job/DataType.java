...
public enum DataType implements DictInstance {
    ...
    @JsonCreator
    public static DataType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, DataType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(DataType.class, code));
    }
