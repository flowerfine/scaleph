...
public enum RegisterChannel implements DictInstance {
    ...
    @JsonCreator
    public static RegisterChannel of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, RegisterChannel.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RegisterChannel.class, code));
    }
