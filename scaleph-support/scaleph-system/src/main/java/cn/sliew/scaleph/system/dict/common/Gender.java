...
public enum Gender implements DictInstance {
    ...
    @JsonCreator
    public static Gender of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, Gender.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(Gender.class, code));
    }
