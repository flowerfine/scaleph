...
public enum RoleStatus implements DictInstance {
    ...
    @JsonCreator
    public static RoleStatus of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, RoleStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(RoleStatus.class, code));
    }
