...
public enum TaskResult implements DictInstance {
    ...
    @JsonCreator
    public static TaskResult of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, TaskResult.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(TaskResult.class, code));
    }
