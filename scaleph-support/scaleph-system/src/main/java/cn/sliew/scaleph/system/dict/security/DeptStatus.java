...
public enum DeptStatus implements DictInstance {
    ...
    @JsonCreator
    public static DeptStatus of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, DeptStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(DeptStatus.class, code));
    }
