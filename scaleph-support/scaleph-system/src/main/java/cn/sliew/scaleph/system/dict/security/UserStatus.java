...
public enum UserStatus implements DictInstance {
    ...
    @JsonCreator
    public static UserStatus of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, UserStatus.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(UserStatus.class, code));
    }
