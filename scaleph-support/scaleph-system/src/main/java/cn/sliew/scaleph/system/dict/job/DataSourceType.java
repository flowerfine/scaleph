...
public enum DataSourceType implements DictInstance {
    ...
    @JsonCreator
    public static DataSourceType of(@JsonProperty("code") String code) {
        return Enums.toEnum(code, DataSourceType.class)
                .orElseThrow(() -> new EnumConstantNotPresentException(DataSourceType.class, code));
    }
